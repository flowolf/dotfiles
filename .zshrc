...
PATH="/usr/local/bin:/usr/local/opt/python@3.8/bin:/Users/$USER/Applications/Scripts:/Users/$USER/Library/Android/sdk/platform-tools:$PATH"
...
#if [ -f '/Users/$USER/Documents/gcloud/google-cloud-sdk/path.bash.inc' ]; then . '/Users/$USER/Documents/gcloud/google-cloud-sdk/path.zsh.inc'; fi
# The next line enables shell command completion for gcloud.
#if [ -f '/Users/$USER/Documents/gcloud/google-cloud-sdk/completion.bash.inc' ]; then . '/Users/$USER/Documents/gcloud/google-cloud-sdk/completion.zsh.inc'; fi
#PROMPT="${PROMPT[1,-4]}"" ${GREEN}>${CYAN}>${BLUE}⋑${NO_COLOUR} "
